...
from models import AgentConfig, Organization, User, WebhookLog, EmailSendLog, EmailEvent, EmailList, ScheduledEmailSend, LeadHunt, EmailSequence, BulkEmailJob, AuditLog  # noqa: F401 — ensures table is registered
    ...
    try:
        ...
        if "organization" in tables:
            ...
            org_new = {
                ...
                "email_attachment_2": "BYTEA" if is_pg else "BLOB",
                "email_attachment_2_name": "VARCHAR(255)",
